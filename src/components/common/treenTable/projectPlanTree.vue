<template>
  <div>
    <el-table :data="dataSource" border style="width: 100%" :row-style="showTr" class="plant-tree">
      ...
      <el-table-column label="当月">
        <el-table-column v-for="(column ,index) in totalColumns.monthPlan" :key="column.text" :label="column.text" :prop="column.dataIndex">
          <template scope="scope">
            {{scope.row[column.dataIndex]}}
          </template>
        </el-table-column>
      </el-table-column>
      <el-table-column label="当月材料用量">
        <el-table-column v-for="(column ,index) in totalColumns.monthMaterials" :key="column.text" :label="column.text" :prop="column.dataIndex">
          <template scope="scope">
            {{scope.row[column.dataIndex]}}
          </template>
        </el-table-column>
      ...
      <el-table-column label="当季">
        <el-table-column v-for="(column ,index) in totalColumns.seasonPlan" :key="column.text" :label="column.text" :prop="column.dataIndex">
          <template scope="scope">
            {{scope.row[column.dataIndex]}}
          </template>
        </el-table-column>
      </el-table-column>
      <el-table-column label="当季材料用量">
        <el-table-column v-for="(column ,index) in totalColumns.seasonMaterials" :key="column.text" :label="column.text" :prop="column.dataIndex">
          <template scope="scope">
            {{scope.row[column.dataIndex]}}
          </template>
        </el-table-column>
      ...
      <el-table-column label="当年">
        <el-table-column v-for="(column ,index) in totalColumns.yearPlan" :key="column.text" :label="column.text" :prop="column.dataIndex">
          <template scope="scope">
            {{scope.row[column.dataIndex]}}
          </template>
        </el-table-column>
      </el-table-column>
      <el-table-column label="当年材料用量">
        <el-table-column v-for="(column ,index) in totalColumns.yearMaterials" :key="column.text" :label="column.text" :prop="column.dataIndex">
          <template scope="scope">
            {{scope.row[column.dataIndex]}}
          </template>
        </el-table-column>
      ...
      <el-table-column label="操作" v-if="treeType === 'normal'" width="150"  fixed="right">
        <template scope="scope">
          ...
          <el-button size="small" type="warning" @click="amendDataTrue(scope.row,scope.$index)">更改</el-button>
        </template>
      </el-table-column>
    </el-table>
    <!-- 修改弹出框-->
